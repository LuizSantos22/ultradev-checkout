...
class UltraDev_Checkout_Block_Checkout extends Mage_Core_Block_Template
{
    ...
    public function getCheckoutConfig()
    {
        ...
        return [
            ...
            'couponUrl'        => Mage::getUrl('ultra-checkout/index/coupon'),
            'updateQtyUrl'     => Mage::getUrl('ultra-checkout/index/updateqty'),
            'cartUrl'          => Mage::getUrl('ultra-checkout/index/cart'),
            'checkEmailUrl'    => Mage::getUrl('ultra-checkout/index/checkemail'),
            'logoutUrl'        => Mage::getUrl('ultra-checkout/index/logout'),
